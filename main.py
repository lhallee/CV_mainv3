...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_img_path', type=str, default='./processed_data/train_img_data.npy')
    parser.add_argument('--train_GT_path', type=str, default='./processed_data/train_GT_data.npy')
    parser.add_argument('--val_img_path', type=str, default='./processed_data/val_img_data.npy')
